...
Questionanswer.create(subject_id: 2, question_id: 1, answer_id: nil)
...
Questionanswer.create(subject_id: 2, question_id: 2, answer_id: nil)
...
Questionanswer.create(subject_id: 2, question_id: 3, answer_id: nil)
...
Questionanswer.create(subject_id: 4, question_id: 4, answer_id: nil)
...
Questionanswer.create(subject_id: 5, question_id: 5, answer_id: nil)
# Yes, in moderation.
